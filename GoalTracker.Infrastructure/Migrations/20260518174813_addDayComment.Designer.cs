...
namespace GoalTracker.Infrastructure.Migrations
{
    ...
    [Migration("20260518174813_addDayComment")]
    partial class addDayComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.DayComment", b =>
                {
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.DoItList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.DoItListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DoItListId");

                    b.HasIndex("UserId");

                    b.ToTable("DoItListItems");
                });
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.ImproveWorking.ExecutionImprovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExecutionImprovements");
                });

            modelBuilder.Entity("GoalTracker.Domain.Entities.ImproveWorking.HistoreImproved", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EntityeId")
                        .HasColumnType("int");

                    b.Property<int?>("ExecutionImprovementId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("StartImprove")
                        .HasColumnType("datetime2");

                    b.Property<int>("TrackedEntitiesType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExecutionImprovementId");

                    b.HasIndex("UserId");

                    b.ToTable("HistoreImproveds");
                });
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.Property<int>("RealPointForTask")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.DoItListItem", b =>
                {
                    b.HasOne("GoalTracker.Domain.Entities.DoItList", "List")
                        .WithMany("Items")
                        .HasForeignKey("DoItListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoalTracker.Domain.Entities.ImproveWorking.HistoreImproved", b =>
                {
                    b.HasOne("GoalTracker.Domain.Entities.ImproveWorking.ExecutionImprovement", null)
                        .WithMany("HistoreImproveds")
                        .HasForeignKey("ExecutionImprovementId");
